 ...
 * to the headline. Swap t-hero.png to change the worker image (keep it a
 * transparent PNG). Served through next/image so it's delivered as an
 * optimized, right-sized webp rather than the raw file.
 */
    ...
    <section className="relative overflow-hidden border-b border-[var(--color-line)]">
      ...
      <div className="relative max-w-6xl mx-auto px-6 sm:px-10">
        <div className="relative h-80 sm:h-96 md:h-[28rem] flex items-center">
          ...
          {/* Worker cutout — transparent PNG, oversized + bottom-anchored, nudged
