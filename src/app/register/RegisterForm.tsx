    ...
    <form action={action} className="space-y-4">
      ...
      <div>
        <label className="block text-xs font-bold text-[var(--color-ink)] mb-1.5">
          パスワード <span className="font-normal text-[var(--color-subtle)]">（6文字以上）</span>
        </label>
      ...
      <div>
        <label className="block text-xs font-bold text-[var(--color-ink)] mb-1.5">パスワード（確認）</label>
      ...
      <p className="text-center text-xs text-[var(--color-subtle)] leading-relaxed">
        登録することで
